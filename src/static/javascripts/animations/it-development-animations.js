...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    tl.to(".preloader", 1, {scaleX: 0, ease: Power4.easeInOut}).set(".preloader", {x: "-100%", scaleX: 1})
	    ...
	    .staggerTo(".intro-description", .7, {y: "0%", ease: Power4.easeOut}, 0.2, "-=0.5")
	    .to("#entwicklung-1 .next-slide", 0.5, {autoAlpha: 1, ease: Power4.easeInOut}, "-=0.5");
...
function entwicklung2Animations() {
    var tl2 = new TimelineMax();
    // set intro animation timeline
    tl2.staggerTo("#entwicklung-2 .img-wrp", .7, {y: "0%", ease: Power4.easeOut}, 0.2, "-=0.25")
	    .staggerTo("#entwicklung-2  h2", .7, {y: "0%", ease: Power4.easeOut}, 0.2, "-=0.5")
	    .staggerTo("#entwicklung-2  p", .7, {y: "0%", ease: Power4.easeOut}, 0.2, "-=0.5")
	    .to("#entwicklung-2 .next-slide", 0.5, {autoAlpha: 1, ease: Power4.easeInOut}, "-=0.5");
}
function entwicklung3Animations() {
    var tl3 = new TimelineMax();
    // set intro animation timeline
    tl3.staggerTo("#entwicklung-3 .dev", .7, {y: "0%", ease: Power4.easeOut}, 0.2, "-=0.25");
}